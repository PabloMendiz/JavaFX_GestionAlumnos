...
public class Controller {
	...
	private final static ObservableList<Alumno> alumnoData = FXCollections.observableArrayList(
			new Alumno("Pablo", "Mendi", "8"), new Alumno("Pablo", "Mendi", "8"), new Alumno("Pablo", "Mendi", "8"), new Alumno("Pablo", "Mendi", "8"));
	...
	public static void setAlumnoData(Alumno registro) {
		alumnoData.add(registro);
	}
}
